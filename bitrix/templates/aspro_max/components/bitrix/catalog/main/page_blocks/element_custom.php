...
<div class="product-view product-view--side-left">
	<?//$templ="main_custom"; if(SITE_TEMPLATE_ID=="aspro_max") $templ="main";?>
	
<?$res = CIBlockSection::GetList(array(), array('IBLOCK_ID' => $arParams["IBLOCK_ID"], 'CODE' => $arResult['VARIABLES']['SECTION_CODE']));
$section = $res->Fetch();
  
global $arrCatalogFilter;
$arrCatalogFilter = array(property_LINK_RAZD => $section["ID"]);
?>
