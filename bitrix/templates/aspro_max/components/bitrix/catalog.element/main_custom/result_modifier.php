...
//var_dump($arParams['LINKED_FILTER_BY_PROP']['EXPANDABLES']);
//var_dump($arParams['LINKED_FILTER_BY_FILTER']['EXPANDABLES']);
...
$arSelect = Array("ID", "IBLOCK_ID", "NAME","PROPERTY_SHIRINA_DLINA_VALUE","PROPERTY_VYSOTA_VALUE","PROPERTY_GLUBINA_VALUE", "DETAIL_PAGE_URL");
$arFilter = Array("IBLOCK_ID"=>$arResult['IBLOCK_ID'], "ACTIVE"=>"Y", "PROPERTY_OBSHCHIY_IDENTIFIKATOR_DLYA_SAYTA"=>$arResult['PROPERTIES']['OBSHCHIY_IDENTIFIKATOR_DLYA_SAYTA']['VALUE']);
$res = CIBlockElement::GetList(Array("SORT"=>"ASC"), $arFilter, false, false, $arSelect);
while($ob = $res->GetNextElement()){
	$arFields = $ob->GetFields();  
      $arResult["DOP_PARAMS"]["SHIRINA_DLINA_VALUE"][] = Array("DLINA_VALUE"=>$arFields["PROPERTY_SHIRINA_DLINA_VALUE_VALUE"], "A_URL"=>$arFields["DETAIL_PAGE_URL"]);
      $arResult["DOP_PARAMS"]["SHIRINA_VYSOTA_VALUE"][] = Array("VYSOTA_VALUE"=>$arFields["PROPERTY_VYSOTA_VALUE_VALUE"], "A_URL"=>$arFields["DETAIL_PAGE_URL"]);
      $arResult["DOP_PARAMS"]["SHIRINA_GLUBINA_VALUE"][] = Array("GLUBINA_VALUE"=>$arFields["PROPERTY_GLUBINA_VALUE_VALUE"], "A_URL"=>$arFields["DETAIL_PAGE_URL"]);
}
...
$arResult["DOP_PARAMS"]["SHIRINA_DLINA_VALUE"] = array_unique_key($arResult["DOP_PARAMS"]["SHIRINA_DLINA_VALUE"], 'DLINA_VALUE'); 
$arResult["DOP_PARAMS"]["SHIRINA_VYSOTA_VALUE"] = array_unique_key($arResult["DOP_PARAMS"]["SHIRINA_VYSOTA_VALUE"], 'VYSOTA_VALUE'); 
$arResult["DOP_PARAMS"]["SHIRINA_GLUBINA_VALUE"] = array_unique_key($arResult["DOP_PARAMS"]["SHIRINA_GLUBINA_VALUE"], 'GLUBINA_VALUE'); 
