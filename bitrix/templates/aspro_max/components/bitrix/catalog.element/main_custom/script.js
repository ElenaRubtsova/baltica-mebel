...
$color_form = $('.obi.block_1 .colle-item.active').data('colorform');
$color_form_name = $('.obi.block_1 .name_kollec').html();
if (!!$color_form) {
	$color_form_rez1 = $color_form_name + $dv_f + $color_form + $zp_f;
}else{$color_form_rez1 = ''}

$color_form = $('.obi.block_2 .colle-item.active').data('colorform');
$color_form_name = $('.obi.block_2 .name_kollec').html();
if (!!$color_form) {
	$color_form_rez2 = $color_form_name + $dv_f + $color_form + $zp_f;
}else{$color_form_rez2 = ''}

$color_form = $('.obi.block_3 .colle-item.active').data('colorform');
$color_form_name = $('.obi.block_3 .name_kollec').html();
if (!!$color_form) {
	$color_form_rez3 = $color_form_name + $dv_f + $color_form + $zp_f;
}else{$color_form_rez3 = ''}

$color_form = $('.obi.block_4 .colle-item.active').data('colorform');
$color_form_name = $('.obi.block_4 .name_kollec').html();
if (!!$color_form) {
	$color_form_rez4 = $color_form_name + $dv_f + $color_form + $zp_f;	
}else{$color_form_rez4 = ''}

$color_form = $('.obi.block_5 .colle-item.active').data('colorform');
$color_form_name = $('.obi.block_5 .name_kollec').html();
if (!!$color_form) {
	$color_form_rez5 = $color_form_name + $dv_f + $color_form + $zp_f;
}else{$color_form_rez5 = ''}

$color_form = $('.obi.block_6 .colle-item.active').data('colorform');
$color_form_name = $('.obi.block_6 .name_kollec').html();
if (!!$color_form) {
	$color_form_rez6 = $color_form_name + $dv_f + $color_form + $zp_f;
}else{$color_form_rez6 = ''}

$color_form = $('.obi.block_7 .colle-item.active').data('colorform');
$color_form_name = $('.obi.block_7 .name_kollec').html();
if (!!$color_form) {
	$color_form_rez7 = $color_form_name + $dv_f + $color_form + $zp_f;
}else{$color_form_rez7 = ''}

$color_form = $('.obi.block_8 .colle-item.active').data('colorform');
$color_form_name = $('.obi.block_8 .name_kollec').html();
if (!!$color_form) {
	$color_form_rez8 = $color_form_name + $dv_f + $color_form + $zp_f;
}else{$color_form_rez8 = ''}

$color_form = $('.obi.block_9 .colle-item.active').data('colorform');
$color_form_name = $('.obi.block_9 .name_kollec').html();
if (!!$color_form) {
	$color_form_rez9 = $color_form_name + $dv_f + $color_form + $zp_f;
}else{$color_form_rez9 = ''}


$color_form_rez = 
	$color_form_rez1 + $color_form_rez2 + $color_form_rez3 + $color_form_rez4 + $color_form_rez5 + $color_form_rez6 + $color_form_rez7 + $color_form_rez8 + $color_form_rez9;
console.log($color_form_rez);
    
	$('input.inputtext[name="form_text_125"]').val($color_form_rez);
}

$(document).ready(function (){

	$(document).on('mouseenter', '.custom_tab button.btn.btn-default.has-ripple', function() {
		form_color();
	});
	$(document).on('mouseenter', '.custom_tab input.inputtext', function() {
		form_color();
	});


    $('.colle-item').bind('click', function() {
        $(this).parent().children(".colle-item").removeClass('active');
	...
	$(".cnt1 .cnt_item").mouseover(function() {
		$('.lup').css( 'display', 'block');
		//$value_img = $(this).attr('data-obgi');
		
		var value_img = $(this).css('background-image');
        bg = value_img.replace('url(','').replace(')','').replace(/\"/gi, "");
		
		// $value_title = $(this).attr('data-namet');
		$value_title = $(this).attr('title');
		$('.src_img').attr('src', bg);
		$('.name_img').html($value_title);
	})

	$(".cnt1 .cnt_item").mouseleave(function() {
...
$(document).ready(function(){
		$('#content').on('click', '.dop_color', function() {
	...
	$('#content').on('click', '.form_blok_lnop.red', function() {
			$('html,body').animate({scrollTop:$('.tabs').offset().top-130+"px"},{duration:1E3});
			$('#desc').removeClass("active");
			$('.char').removeClass("active");
			$('.stores').removeClass("active");
	...
	$('#content').on('click', '.napolnenie', function() {
